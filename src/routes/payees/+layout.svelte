...
<div class="flex flex-row w-full h-full">
    <AppRail>
        <AppRailTile on:click={() => onAppTileClicked("/payees/overview")} bind:group={currentTile.currentTile} name="tile-1" value={0} title="tile-1">
        ...
        <AppRailTile on:click={() => onAppTileClicked("/payees/add")} bind:group={currentTile.currentTile} name="tile-2" value={1} title="tile-2">
            <svelte:fragment slot="lead">
                <span class="flex justify-center w-full">
        ...
        <AppRailTile on:click={() => onAppTileClicked("/payees/edit")} bind:group={currentTile.currentTile} name="tile-3" value={2} title="tile-3">
            <svelte:fragment slot="lead">
                <span class="flex justify-center w-full">
        ...
        <AppRailTile on:click={() => onAppTileClicked("/payees/export")} bind:group={currentTile.currentTile} name="tile-4" value={3} title="tile-3">
            <span class="flex justify-center w-full">
                <Icon icon="material-symbols:file-export-rounded" width="24" height="24" />
            </span>
            <span>Export</span>
        </AppRailTile>
        <AppRailTile on:click={() => onAppTileClicked("/payees/import")} bind:group={currentTile.currentTile} name="tile-3" value={4} title="tile-3">
            <span class="flex justify-center w-full">
